...
public interface compUnitVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link compUnitParser#type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitType(compUnitParser.TypeContext ctx);
	/**
	 * Visit a parse tree produced by {@link compUnitParser#funcFParams}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncFParams(compUnitParser.FuncFParamsContext ctx);
	/**
	 * Visit a parse tree produced by {@link compUnitParser#funcFParam}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncFParam(compUnitParser.FuncFParamContext ctx);
	/**
	 * Visit a parse tree produced by {@link compUnitParser#dimension}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDimension(compUnitParser.DimensionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link compUnitParser#condition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCondition(compUnitParser.ConditionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link compUnitParser#lorExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLorExp(compUnitParser.LorExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link compUnitParser#relExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRelExp(compUnitParser.RelExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link compUnitParser#eqExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEqExp(compUnitParser.EqExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link compUnitParser#landExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLandExp(compUnitParser.LandExpContext ctx);
	/**
